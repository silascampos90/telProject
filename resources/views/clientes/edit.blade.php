                                    ...
                                    <div class="card card-container">
                                        ...
                                        <form action="{{route('clientes.update', ['clientes' => $clientes->id])}}" method="post">
                                            <div class="form-group">
                                                ...
                                                <label for="">CPF</label>
                                                <input type="text" class="form-control" name="cpf" value="{{$clientes->cpf}}" required>
                                                <label for="">RG</label><span id="rg-span" style="color:brown"> - Campo Obrigatório*</span>
                                                <input id="idRg" type="text" class="form-control" name="rg" value="{{$clientes->rg}}" >
                                                <label for="">Naturalidade:</label>
                                                <select id="idNascimento" class="form-control" name="local_nascimento" required>
                                                    <option value="ba" {{ ( $clientes->local_nascimento == 'ba' ) ? 'selected' : '' }}>BA</option>
                                                    <option value="sp" {{ ( $clientes->local_nascimento == 'sp' ) ? 'selected' : '' }}>SP</option>
                                                </select>
                                               
                                                <label for="">Data de Nascimento</label>
                                                <input id="idDate" type="date" class="form-control" name="data_nascimento" value="{{$clientes->data_nascimento}}" required>
                                                <label for="">Telefone</label>
                                                <input type="text" class="form-control" name="telefone" value="{{$clientes->telefone}}" required>
