                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edita Usuário</h6>
                            @include('flash::message')
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="col-md-4" style="margin: auto">
                                    <form action="{{route('usuarios.update', ['usuarios' => $usuarios->id])}}" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="password" value="{{$usuarios->senha}}">
                                        </div>
